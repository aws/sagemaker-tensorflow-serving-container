...
- `method`: inference method, for example, 'predict', 'classify' or 'regress'
- `rest_uri`: the TFS REST uri generated by the Python service
- `grpc_uri`: the GRPC uri generated by the Python service
- `custom_attributes`: content of 'X-Amzn-SageMaker-Custom-Attributes' header from the original request
